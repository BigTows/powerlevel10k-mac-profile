...
() {
  ...
  #Suffix for OS Icon
  typeset -g CUSTOM_SUFFIX_OS_ICON_CONTENT='BigTows'
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$(awk -v min=10 -v max=255 'BEGIN{srand(); print int(min+rand()*(max-min+1))}')
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=' $CUSTOM_SUFFIX_OS_ICON_CONTENT'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_BOLD=tr
